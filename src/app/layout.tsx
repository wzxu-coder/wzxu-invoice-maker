...
export const metadata={title:"WZXU Invoice Maker — Free Invoice Generator",description:"Create professional invoices without an account. Save drafts locally and download a clean PDF.",verification:{google:"VK0Bb-IeIPIPPYW5Uq2-8Vs3NlXXFES4JiaSViDGjK8"}};
